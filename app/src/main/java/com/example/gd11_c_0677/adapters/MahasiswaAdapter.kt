package com.example.gd11_c_0677.adapters
...
import com.example.gd11_c_0677.AddEditActivity
import com.example.gd11_c_0677.MainActivity
import com.example.gd11_c_0677.R
import com.example.gd11_c_0677.models.Mahasiswa
...
class MahasiswaAdapter (private var  mahasiswaList: List<Mahasiswa>, context: Context) :
    ...
    private var fillteredMahasiswaList: MutableList<Mahasiswa>
    private val context : Context

    init {
        fillteredMahasiswaList = ArrayList(mahasiswaList)
    ...
    override fun getItemCount(): Int {
        return fillteredMahasiswaList.size
    }

    fun setMahasiswaList(mahasiswaList: Array<Mahasiswa>) {
        this.mahasiswaList = mahasiswaList.toList()
        fillteredMahasiswaList = mahasiswaList.toMutableList()
    }

    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        val mahasiswa = fillteredMahasiswaList[position]
    ...
    override fun getFilter(): Filter {
        return object : Filter() {
            ...
            override fun publishResults(charSequence: CharSequence, filterResults: FilterResults) {
                fillteredMahasiswaList.clear()
                fillteredMahasiswaList.addAll((filterResults.values as kotlin.collections.List<Mahasiswa>))
